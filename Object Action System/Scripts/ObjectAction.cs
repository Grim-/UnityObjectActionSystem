...
namespace Grim.ObjectActionSystem
{
    ...
    public abstract class ObjectAction : ScriptableObject
    {
        ...
        //Not sure it's possible to nest actions when the actions rely on instanced serialized data
        ...
        public void AddDefaultForceMode(string name, ForceMode forceMode)
        {
            EnumValue newFloat = new EnumValue(name, forceMode);
